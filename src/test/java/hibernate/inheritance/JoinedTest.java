...
import ru.aston.mineev_ia.task9.hibernate.inheritance.joined.models.BankAccount;
import ru.aston.mineev_ia.task9.hibernate.inheritance.joined.models.CreditCard;
import ru.aston.mineev_ia.task9.hibernate.inheritance.joined.models.BillingDetails;
...
public class JoinedTest {
    ...
    void selectAll() {
        try {
            session = sessionFactory.openSession();
            session.beginTransaction();
            List<BillingDetails> billingDetails = session.createQuery("select bd from ru.aston.mineev_ia.task9.hibernate.inheritance.joined.models.BillingDetails bd", BillingDetails.class).list();
