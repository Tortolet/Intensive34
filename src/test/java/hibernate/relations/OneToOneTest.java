...
import ru.aston.mineev_ia.task9.hibernate.relations.one_to_one.Employee;
import ru.aston.mineev_ia.task9.hibernate.relations.one_to_one.Position;
...
public class OneToOneTest {
    ...
    void selectAll() {
        try {
            session = sessionFactory.openSession();
            session.beginTransaction();
            List<Employee> employees = session.createQuery("select e from ru.aston.mineev_ia.task9.hibernate.relations.one_to_one.Employee e join fetch e.position", Employee.class).list();
